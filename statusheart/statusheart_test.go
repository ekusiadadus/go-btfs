...
func TestReportStatusHeartPackInput(t *testing.T) {
	peer := "1"
	createTime := uint32(1)
	version := "1"
	num := uint32(3)
	...
	fmt.Println("...... ReportHeartStatus, param = ", peer, createTime, version, num, bttcAddress, signature, err)
	...
	fmt.Println("...... ReportHeartStatus, callData, err = ", common.Bytes2Hex(callData), err)
}
